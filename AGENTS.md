...
- **OMP skills:** canonical skill sources live in `.omp/skills/`; the runtime `~/.omp/skills` is a symlink to that directory, and `~/.omp/agent/skills` follows the same path. Edit skills in the repository source; do not edit the live path directly.
